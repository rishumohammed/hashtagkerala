...
onMounted(async () => {
  ...
  try {
    const data = await getHotelBySlug(route.params.slug)
      ...
      <div class="absolute inset-0 flex flex-col justify-end pb-12 sm:pb-16">
        <div class="shell-container">
          ...
          <div class="mt-8 flex flex-wrap gap-3">
            <a :href="`https://wa.me/919876543210?text=${encodeURIComponent('I am interested in booking a stay at ' + hotel.name + '. Please provide more information about availability and rates.')}`" target="_blank" rel="noreferrer"
